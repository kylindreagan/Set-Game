    ...
    public partial class GameForm : Form
    {
        ...
        private void createPictures()
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                pictures[i].Width = 120;
                pictures[i].Height = 120;
            ...
            pictures[0].Location = new Point(450, 30);
            pictures[1].Location = new Point(750, 30);
            pictures[2].Location = new Point(1050, 30);
            pictures[3].Location = new Point(600, 160);
            pictures[4].Location = new Point(900, 160);
            pictures[5].Location = new Point(450, 280);
            pictures[6].Location = new Point(750, 470);
            pictures[7].Location = new Point(1050, 280);
            pictures[8].Location = new Point(600, 400);
            pictures[9].Location = new Point(900, 400);

            checkboxes[0].Location = new Point(450, 30);
            checkboxes[1].Location = new Point(750, 30);
            checkboxes[2].Location = new Point(1050, 30);
            checkboxes[3].Location = new Point(600, 160);
            checkboxes[4].Location = new Point(900, 160);
            checkboxes[5].Location = new Point(450, 280);
            checkboxes[6].Location = new Point(750, 470);
            checkboxes[7].Location = new Point(1050, 280);
            checkboxes[8].Location = new Point(600, 400);
            checkboxes[9].Location = new Point(900, 400);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (numSets > 0)
                {
                    Console.WriteLine("Among us sussy");
